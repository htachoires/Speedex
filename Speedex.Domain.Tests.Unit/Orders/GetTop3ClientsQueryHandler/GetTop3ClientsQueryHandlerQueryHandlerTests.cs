...
namespace Speedex.Domain.Tests.Unit.Orders.GetTop3ClientsQueryHandler;

public class GetTop3ClientsQueryHandler
{
    [Fact]
    public async Task Query_Should_Return_Top3Clients()
    {
        // Arrange
